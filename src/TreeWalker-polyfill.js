...
NodeFilter.constructor = NodeFilter.prototype = NodeFilter;
 ...
 * @throws Error
 */
export function TreeWalker(root, whatToShow, filter) {
	...
	if (!is(filter, 'function')) {
		...
		tw.filter = create(NodeFilter.prototype);
